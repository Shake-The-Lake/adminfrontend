...
const HeaderLogo: React.FC<HeaderLogoProps> = ({hasLink = true}) => {
	...
	return (
		<div
			className="flex h-14 items-center px-4 lg:h-[var(--header-height)] lg:px-6">
			<Link to="/" style={hasLink ? undefined : {pointerEvents: 'none'}} className="flex items-center gap-2 font-semibold">
