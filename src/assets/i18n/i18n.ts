...
const resources: Resource = {
	en: {
		translation: {
			...
			name: 'Name',
			email: 'Email',
			infoTextUmat: 'This are the person who edited the booking',
			createdBy: 'Created',
			modifiedBy: 'Modified',
			phone: 'Phone Number',
	...
	de: {
		translation: {
			...
			name: 'Name',
			email: 'E-Mail',
			infoTextUmat: 'Das sind die Personen welche die Buchung bearbeitet haben',
	...
	gsw: {
		translation: {
			...
			infoTextUmat: 'Hiä gsesch wär d ihstellig aus letsts Veränderet het.',
